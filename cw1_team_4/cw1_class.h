...
public: 
  ...
  double approach_distance_box = 0.125;
 ...
 */
   ...
   */
  void getColorCloud(pcl::EuclideanClusterExtraction<pcl::PointXYZRGB>& ec, pcl::search::KdTree<pcl::PointXYZRGB>::Ptr tree, pcl::PointCloud<pcl::PointXYZRGB>::Ptr color_cloud, 
